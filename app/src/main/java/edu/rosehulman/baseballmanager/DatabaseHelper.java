...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	static {
	 	...
	 	sb.append(PlayerDataAdapter.KEY_DEPTH_CHART_P + " integer, ");
	 	sb.append(PlayerDataAdapter.KEY_DEPTH_CHART_C + " integer, ");
	 	sb.append(PlayerDataAdapter.KEY_DEPTH_CHART_1B + " integer, ");
	 	sb.append(PlayerDataAdapter.KEY_DEPTH_CHART_2B + " integer, ");
	 	sb.append(PlayerDataAdapter.KEY_DEPTH_CHART_3B + " integer, ");
	 	sb.append(PlayerDataAdapter.KEY_DEPTH_CHART_SS + " integer, ");
	 	sb.append(PlayerDataAdapter.KEY_DEPTH_CHART_LF + " integer, ");
	 	sb.append(PlayerDataAdapter.KEY_DEPTH_CHART_CF + " integer, ");
	 	sb.append(PlayerDataAdapter.KEY_DEPTH_CHART_RF + " integer, ");
