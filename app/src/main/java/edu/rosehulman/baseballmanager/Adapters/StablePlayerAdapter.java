...
public class StablePlayerAdapter extends ArrayAdapter<String> {
    ...
    public void saveState(ArrayList<Player> players) {
    	...
    	case DC_P:
    		for (int i = 0; i < players.size(); i++) {
        		players.get(i).setDepthChartP(i);
            	mPlayerDataAdapter.updatePlayer(players.get(i));
        	}
    		break;
    	case DC_C:
    		for (int i = 0; i < players.size(); i++) {
        		players.get(i).setDepthChartC(i);
            	mPlayerDataAdapter.updatePlayer(players.get(i));
        	}
    		break;
    	case DC_1B:
    		for (int i = 0; i < players.size(); i++) {
        		players.get(i).setDepthChart1B(i);
            	mPlayerDataAdapter.updatePlayer(players.get(i));
        	}
    		break;
    	case DC_2B:
    		for (int i = 0; i < players.size(); i++) {
        		players.get(i).setDepthChart2B(i);
            	mPlayerDataAdapter.updatePlayer(players.get(i));
        	}
    		break;
    	case DC_3B:
    		for (int i = 0; i < players.size(); i++) {
        		players.get(i).setDepthChart3B(i);
            	mPlayerDataAdapter.updatePlayer(players.get(i));
        	}
    		break;
    	case DC_SS:
    		for (int i = 0; i < players.size(); i++) {
        		players.get(i).setDepthChartSS(i);
            	mPlayerDataAdapter.updatePlayer(players.get(i));
        	}
    		break;
    	case DC_LF:
    		for (int i = 0; i < players.size(); i++) {
        		players.get(i).setDepthChartLF(i);
            	mPlayerDataAdapter.updatePlayer(players.get(i));
        	}
    		break;
    	case DC_CF:
    		for (int i = 0; i < players.size(); i++) {
        		players.get(i).setDepthChartCF(i);
            	mPlayerDataAdapter.updatePlayer(players.get(i));
        	}
    		break;
    	case DC_RF:
    		for (int i = 0; i < players.size(); i++) {
        		players.get(i).setDepthChartRF(i);
            	mPlayerDataAdapter.updatePlayer(players.get(i));
        	}
    		break;
    	}
