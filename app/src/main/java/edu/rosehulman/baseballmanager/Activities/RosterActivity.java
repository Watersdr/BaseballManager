...
import edu.rosehulman.baseballmanager.DepthChartFragment;
import edu.rosehulman.baseballmanager.LineupFragment;
import edu.rosehulman.baseballmanager.OnUpdateRosterListener;
...
public class RosterActivity extends Activity implements OnUpdateRosterListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Player> players = mPlayerDataAdapter.getTeamPlayersById(teamID);
